...
const ContractStartGame = (game_id: string) => {
    console.log("WEB3: called contract with game id :" + game_id);
    ...
    const signer = async () => {
        ...
        console.log("WEB3: going to call await signer... ")
            ...
            ({ status }) => {
              if (status.isInBlock) {
                alert.success(status.asInBlock.toString());
                  ...
                  console.log("WEB3: Game has started in the contract");
